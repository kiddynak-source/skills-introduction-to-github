...
![Compare & pull request](https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/compare-pull-request-button.png?raw=true)
...
3. ドロップダウンで次のブランチを選びます。
   ...
   ![ブランチの選択](https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/branch-selection-comparison.png?raw=true)
...
6. 次の欄は変更の**説明**です。ここまでにやったことを短く書きます。やったことは、新しいブランチを作った、ファイルを作った、コミットした、の 3 つです。
   ...
   ![pull request の作成](https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/create-pull-request-form.png?raw=true)
