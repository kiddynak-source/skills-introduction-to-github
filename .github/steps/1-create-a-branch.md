...
![プロフィール README の例](https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/example-profile-readme.png?raw=true)
...
2. リポジトリ上部のメニューで **< > Code** タブを開きます。
   ...
   ![Code タブ](https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/code-tab-highlight.png?raw=true)

3. **main** と書かれたブランチのドロップダウンをクリックします。

   <img width="300" alt="ブランチ選択" src="https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/branch-selection-dropdown.png?raw=true">
...
5. **Create branch: `my-first-branch` from main** という文字をクリックしてブランチを作ります。
   ...
   <img width="300" alt="ブランチ作成" src="https://github.com/kiddynak-source/skills-introduction-to-github/blob/main/.github/images/create-branch-prompt.png?raw=true">
